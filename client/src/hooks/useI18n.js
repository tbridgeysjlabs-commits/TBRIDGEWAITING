...
const fallback = {
  ko: {
    ...
    terms_label_privacy: '개인정보 수집 및 이용 동의',
    terms_label_marketing: '마케팅 목적의 개인정보 수집 및 이용 동의',
    required_tag: '[필수]',
    optional_tag: '[선택]',
  ...
  en: {
    ...
    terms_label_marketing: 'Marketing use of personal information',
  ...
  ja: {
    ...
    terms_label_marketing: 'マーケティング目的の個人情報の収集・利用への同意',
    required_tag: '[必須]',
    optional_tag: '[任意]',
    agree_continue: '同意して続ける',
    register_waiting: 'ウェイティング登録',
    registering: '登録中...',
    terms_required: '利用規約に同意（必須）',
    privacy_required: '個人情報の収集・利用に同意（必須）',
  ...
  zh: {
    ...
    terms_label_privacy: '同意收集及使用个人信息',
    terms_label_marketing: '同意营销目的的个人信息收集及使用',
    required_tag: '[必填]',
    optional_tag: '[可选]',
    ...
    marketing_optional: '同意营销相关个人信息收集（可选）',
    agree: '同意',
